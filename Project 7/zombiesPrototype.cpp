...
class Zombie
{
  ...
  private:
    ...
    int    m_row;
    int    m_col;
      // TODO: You'll probably find that a zombie object needs additional
...
{
      // TODO: Return whether the zombie is dead
...
void Arena::display(string msg) const
{
    ...
    for (r = 1; r <= rows(); r++)
      ...
      // TODO:  If one zombie is at some grid point, set the displayGrid char
